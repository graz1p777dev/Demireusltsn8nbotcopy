...
const CHANGELOG: ChangeGroup[] = [
  {
    ...
    date: "01.07.2026",
    entries: [
      { date: "01.07.2026", tag: "improve", text: "Мобильная адаптация CRM: гамбургер-меню, боковая панель как drawer, переключение между списком и чатом" },
      { date: "01.07.2026", tag: "improve", text: "История чата: мобильная вёрстка — имя обрезается ellipsis, телефон на отдельной строке, кнопка amoCRM — иконка" },
      { date: "01.07.2026", tag: "fix", text: "Редактирование ответа: db.refresh перед обновлением карточки исправляет ошибку «ответ не меняется»" },
      { date: "01.07.2026", tag: "improve", text: "Уведомление менеджеру если карточка Telegram не обновилась — «ответ сохранён, нажмите Принять»" },
      { date: "01.07.2026", tag: "improve", text: "Новый тёмный дизайн CRM: цвета взяты с логотипа магазина (глубокий navy #080F1D)" },
      { date: "01.07.2026", tag: "fix", text: "Телефон клиента: форматирование +996 XXX XXX XXX вместо числа-ID из amoCRM" },
      { date: "01.07.2026", tag: "fix", text: "Фото клиента: отображается как реальное фото вместо текста [picture] https://..." },
      { date: "01.07.2026", tag: "fix", text: "Голосовые сообщения: исправлена транскрипция — URL брался из поля media, не attachment_link" },
      { date: "01.07.2026", tag: "fix", text: "Аналитика: счётчик «Принято» теперь учитывает статус sent и approved (раньше показывал 0)" },
      { date: "01.07.2026", tag: "feature", text: "Детали диалога: кнопка «Детали диалога» скрывает/показывает блоки Extracted fields, Usage, Approvals" },
    ],
  },
  {
    version: "1.12",
    date: "29.06.2026",
    entries: [
      { date: "29.06.2026", tag: "feature", text: "Telegram хэштеги: #номер #проблема #город в конце карточки — поиск по тегу в чате" },
      { date: "29.06.2026", tag: "improve", text: "Напоминание об опоздании: предупреждение удаляется когда менеджер принимает/отклоняет" },
      { date: "29.06.2026", tag: "feature", text: "Голосовые сообщения: транскрипция через Whisper, только русский и кыргызский" },
      { date: "29.06.2026", tag: "feature", text: "Двухуровневая модель: простые вопросы → GPT-5.1, сомнения/возражения → GPT-5.5" },
      { date: "29.06.2026", tag: "feature", text: "Возраст клиента: ИИ спрашивает возраст при известной проблеме кожи" },
      { date: "29.06.2026", tag: "feature", text: "Аналитика «Возраст × Проблема»: сводная таблица в разделе аналитики" },
      { date: "29.06.2026", tag: "improve", text: "Карточка решения: показывает кто принял — «✅ Принято · Аружан · 17:39»" },
      { date: "29.06.2026", tag: "improve", text: "Фото клиента: отправляются как ответ на карточку, а не отдельным сообщением" },
    ],
  },
  {
    version: "1.11",
    date: "29.06.2026",
    entries: [
      { date: "29.06.2026", tag: "feature", text: "Шаблоны ответов: управление в настройках, кнопка «📋 Шаблоны» в Telegram карточке" },
      { date: "29.06.2026", tag: "feature", text: "Статус «редактирует»: карточка показывает ⏳ Редактирует: [Имя] пока менеджер пишет" },
      { date: "29.06.2026", tag: "feature", text: "Напоминание об опоздании: Celery бьёт тревогу если ответ висит pending > 15 мин" },
      { date: "29.06.2026", tag: "feature", text: "Тёмная/светлая тема: кнопка 🌙/☀️ в шапке CRM, запоминается в localStorage" },
      { date: "29.06.2026", tag: "feature", text: "Экспорт CSV: кнопка ⬇️ в списке диалогов скачивает всех лидов с телефонами" },
      { date: "29.06.2026", tag: "improve", text: "Аналитика: линейные графики вместо столбчатых, разбивка токенов по задачам" },
      { date: "29.06.2026", tag: "improve", text: "Гипервизор пропускает резюме если у клиента только одно сообщение" },
      { date: "29.06.2026", tag: "fix", text: "Клик по диалогу не работал из-за истёкшей JWT-сессии — теперь редиректит на /login" },
      { date: "29.06.2026", tag: "improve", text: "Прокси /api/backend теперь поддерживает DELETE-запросы" },
    ],
  },
  {
    version: "1.10",
