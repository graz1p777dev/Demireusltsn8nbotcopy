...
export default function HelpPage() {
  return (
    <div className="flex max-w-3xl flex-col gap-4">
      ...
      <Section icon={LayoutDashboard} title="Главная" status="wip">
        <p>
          ...
          остатков на складе. Сейчас используются демонстрационные данные; подключение к реальным цифрам — в работе.
        </p>
      </Section>
